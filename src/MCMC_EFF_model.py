...
def log_prior(theta):
    ...
    if rho_0 > 0. and a > 0. and gamma > 0. and a < 1000.:
...
times = np.loadtxt('/Users/BrianTCook/Desktop/wide_orbits_in_associations/data/forward_in_time/snapshot_times_forward.txt')

for i, file in enumerate(files):

    if i == 13:
    
        print('time is: %.02f Myr'%(times[20*i]))
