...
time_arrows = [ 'forward', 'backward' ]

for arrow in time_arrows:
    
    phasespace_files = glob.glob(wide_orbits_direc + 'data/%s_in_time/phasespace_%s_*.ascii'%(arrow, arrow))
    times = np.loadtxt(wide_orbits_direc + 'data/%s_in_time/snapshot_times_%s.txt'%(arrow, arrow))
    
    galaxy_mass_list = np.loadtxt(wide_orbits_direc + 'data/%s_in_time/snapshot_galaxy_masses_%s.txt'%(arrow, arrow))
